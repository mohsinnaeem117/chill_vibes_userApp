...
import com.example.chillvibes.databinding.CartItemBinding
...
class CartAdapter(
    ...
    inner class CartViewHolder(private val binding: CartItemBinding) :
        ...
        private fun deceasedQuantity(position: Int) {
        ...
        private fun removeItem(position: Int, uniqueKey: String) {
            if (uniqueKey != null) {
                cartItemsReference.child(uniqueKey).removeValue().addOnSuccessListener {
                    ...
                    Toast.makeText(context, "Items remove successfully", Toast.LENGTH_SHORT).show()
